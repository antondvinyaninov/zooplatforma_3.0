            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg p-6 border border-blue-200">
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center gap-4">
                  ...
                  {/* Информация */}
                  <div>
                    <h4 className="text-xl font-bold text-gray-900 mb-1">{pet.owner_name}</h4>
                    <p className="text-sm text-gray-600">
                      ID пользователя:{' '}
                      <span className="font-mono font-semibold">#{pet.owner_id}</span>
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-lg p-6 border border-purple-200">
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex items-center gap-4">
                      ...
                      {/* Информация */}
                      <div>
                        <h4 className="text-xl font-bold text-gray-900 mb-1">{pet.curator_name}</h4>
                        <p className="text-sm text-gray-600">
                          ID пользователя:{' '}
                          <span className="font-mono font-semibold">#{pet.curator_id}</span>
                        </p>
                      </div>
                    </div>
                  </div>
