...
export default function PetHealth({ isEditing, pet, editData, setEditData }: PetHealthProps) {
  ...
  const fetchVaccinations = async () => {
    try {
      const response = await fetch(`/api/petid/pets/${pet.id}/vaccinations`, {
        credentials: 'include',
      });
      if (response.ok) {
  ...
  const fetchTreatments = async () => {
    try {
      const response = await fetch(`/api/petid/pets/${pet.id}/treatments`, {
        credentials: 'include',
      });
      if (response.ok) {
        const data = await response.json();
  ...
  const fetchMedicalRecords = async () => {
    try {
      const response = await fetch(`/api/petid/pets/${pet.id}/medical-records`, {
        credentials: 'include',
      });
      if (response.ok) {
        const data = await response.json();
  ...
  const handleDeleteVaccination = async (id: number) => {
    setIsDeleting(true);
    try {
      const response = await fetch(`/main/api/owner/vaccinations/${id}`, {
        method: 'DELETE',
        credentials: 'include',
      });
  ...
  const handleUpdateVaccination = async () => {
    ...
    try {
      const response = await fetch(`/main/api/owner/vaccinations/${editingVaccination.id}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleDeleteMedicalRecord = async (id: number) => {
    setIsDeleting(true);
    try {
      const response = await fetch(`/main/api/owner/medical-records/${id}`, {
        method: 'DELETE',
        credentials: 'include',
      });
  ...
  const handleUpdateMedicalRecord = async () => {
    ...
    try {
      const response = await fetch(`/main/api/owner/medical-records/${editingMedicalRecord.id}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleDeleteTreatment = async (id: number) => {
    setIsDeleting(true);
    try {
      const response = await fetch(`/main/api/owner/treatments/${id}`, {
        method: 'DELETE',
        credentials: 'include',
      });
  ...
  const handleUpdateTreatment = async () => {
    ...
    try {
      const response = await fetch(`/main/api/owner/treatments/${editingTreatment.id}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
