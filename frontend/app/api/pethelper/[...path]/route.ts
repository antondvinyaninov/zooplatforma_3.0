...
async function proxyRequest(request: NextRequest, params: { path: string[] }) {
  try {
    ...
    const backendUrl = `${BACKEND_API_URL}/api/pethelper/${path}${queryString}`;

    console.log(`[PetHelper Proxy] ${request.method} ${backendUrl}`);
    ...
    console.error('[PetHelper Proxy Error]', error);
