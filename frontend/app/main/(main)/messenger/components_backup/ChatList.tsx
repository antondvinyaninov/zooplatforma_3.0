        ...
        {loading ? (
          ...
          chats.map((chat) => (
            <button
              ...
              className={`w-full ${isCollapsed ? 'p-2' : 'p-3'} flex ${isCollapsed ? 'justify-center' : 'items-start gap-3'} hover:bg-gray-50 transition-colors border-b border-gray-100 ${selectedChatId === chat.id ? 'bg-[#EAF2FF]' : ''}`}
